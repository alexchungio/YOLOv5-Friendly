...
class YOLOHead(nn.Module):
    def __init__(
        ...
        self.output_channels = (num_classes + 5) * self.num_anchors # (80(classify) + 4(box) + 1(obj_conf)) * 3(anchor)
        self.stride = stride
    ...
    def forward(self, x):
        ...
        for i in range(self.num_layers):
            ...
            if not self.training:
                ...
                out.append(xy_wh_conf.view(batch_size, self.num_anchors * num_x * num_y, self.output_channels))
