...
```bash
python train.py --img 640 --batch 16 --epochs 3 --dataset coco128.yaml --weights yolov5s.pt --cache
```

or with custom project and task name:
```bash
python train.py --project my_project --name my_training --img 640 --batch 16 --epochs 3 --dataset coco128.yaml --weights yolov5s.pt --cache
```
...
```bash
cd coco128
clearml-dataset sync --project YOLOv5 --name coco128 --folder .
```
...
clearml-dataset create --name coco128 --project YOLOv5
clearml-dataset add --files .
clearml-dataset close
```
...
```bash
python train.py --img 640 --batch 16 --epochs 3 --dataset clearml://<your_dataset_id> --weights yolov5s.pt --cache
```
