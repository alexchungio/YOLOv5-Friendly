...
class ClearmlLogger:
    """Log training runs, dataset, models, and predictions to ClearML.
    ...
    basic dataset metrics and analyses.

    By providing additional command line arguments to train.py, dataset,
    ...
    def __init__(self, opt, hyp):
        ...
        if self.clearml:
            ...
            if opt.data.startswith('clearml://'):
                ...
                # names, nc (number of classes), test, train, val (all three relative paths to ../dataset)
                self.data_dict = construct_dataset(opt.data)
                # Set dataset to data_dict because wandb will crash without this information and opt is the best way
                # to give it to them
    ...
    def log_image_with_boxes(self, image_path, boxes, class_names, image, conf_threshold=0.25):
        ...
        image (Tensor): A torch tensor containing the actual image dataset
        """
