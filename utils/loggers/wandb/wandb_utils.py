...
from data.dataloaders import LoadImagesAndLabels, img2label_paths
...
class WandbLogger():
    """Log training runs, dataset, models, and predictions to Weights & Biases.
        ...
        if self.wandb_run:
            if self.job_type == 'Training':
                ...
                if isinstance(opt.data, dict):
                    ...
                    # and they will have stored the already processed dict in opt.dataset
    ...
    def create_dataset_table(self, dataset: LoadImagesAndLabels, class_to_id: Dict[int, str], name: str = 'dataset'):
        ...
        for img_file in img_files:
            if Path(img_file).is_dir():
                ...
                artifact.add_file(str(label_file), name='dataset/labels/' +
